...
UPDATE `infostretchreferralsql`.`user` SET `password`=NULL WHERE `id`='3';
UPDATE `infostretchreferralsql`.`user` SET `password`=NULL WHERE `id`='4';
UPDATE `infostretchreferralsql`.`user` SET `password`=NULL WHERE `id`='5';
UPDATE `infostretchreferralsql`.`user` SET `password`=NULL WHERE `id`='6';
UPDATE `infostretchreferralsql`.`user` SET `password`=NULL WHERE `id`='7';
UPDATE `infostretchreferralsql`.`user` SET `password`=NULL WHERE `id`='8';
UPDATE `infostretchreferralsql`.`user` SET `password`=NULL WHERE `id`='9';
UPDATE `infostretchreferralsql`.`user` SET `password`='' WHERE `id`='10';
...
INSERT INTO `infostretchreferralsql`.`user_role_mapping` (`id`, `role_id`, `user_id`) VALUES ('1', '1', '1');
INSERT INTO `infostretchreferralsql`.`user_role_mapping` (`id`, `role_id`, `user_id`) VALUES ('2', '2', '2');
UPDATE `infostretchreferralsql`.`user` SET `name`='hr.admin', `password`='admin@123', `firstname`='HR', `lastname`='Admin' WHERE `id`='1';
UPDATE `infostretchreferralsql`.`user` SET `name`='sales.admin', `password`='admin@123', `firstname`='Sales', `lastname`='Admin' WHERE `id`='2';
